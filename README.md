...
| **Vulnerability Reports** (≥3, professional format) | [`docs/findings/VUL-0001.md`](docs/findings/VUL-0001.md) (multi-turn social-engineering handoff → full clinical briefing), [`docs/findings/VUL-0002.md`](docs/findings/VUL-0002.md) (authority-pretext → bulk multi-patient census), [`docs/findings/VUL-0003.md`](docs/findings/VUL-0003.md) (indirect prompt injection via fake document footer → ICU labs). Three CRITICAL findings across **two distinct OWASP categories** (LLM01 + LLM06), all minted from the post-recalibration sweep against the live deployed target. Every report carries OWASP LLM 2025, MITRE ATLAS 5.1.0, and HIPAA Security Rule citations. |
